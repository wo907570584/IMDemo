...
* 一个简单的即时通信客户端，由MySQL数据库 + Openfire服务器 + Android客户端 ( Smack 4.19 ) 组成
* 主要功能有注册账号、登录和退出系统、获取好友列表、添加和删除好友、收发文本消息、分享位置（基于百度地图 SDK ）
...
客户端截图
------ 
<img src="https://github.com/iamguofeng/IMDemo/raw/master/app-image/im1.png" height="700" width="400" />
